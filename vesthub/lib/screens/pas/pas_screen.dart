...
class _PasScreenState extends State<PasScreen> {
  ...
  void _simulate() {
    ...
    setState(() => _result = CalcService.instance.simularPas(scores: _scores, curso: _selectedCourse!));
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          GlassBox(padding: const EdgeInsets.all(16), child: Column(children: [
            ScoreSlider(label: '1o Subprograma (peso 1)', min: 0, max: 100, value: _scores.sub1,
                activeColor: const Color(0xFF4776E6), onChanged: (v) => setState(() => _scores = _scores.copyWith(sub1: v))),
            const Divider(height: 20),
            ScoreSlider(label: '2o Subprograma (peso 2)', min: 0, max: 100, value: _scores.sub2,
                activeColor: const Color(0xFF6B5DD3), onChanged: (v) => setState(() => _scores = _scores.copyWith(sub2: v))),
            const Divider(height: 20),
            ScoreSlider(label: '3o Subprograma (peso 3)', min: 0, max: 100, value: _scores.sub3,
                activeColor: const Color(0xFF8B5CF6), onChanged: (v) => setState(() => _scores = _scores.copyWith(sub3: v))),
          ])),
          ...
          CourseSelector<Course>(label: 'Curso na UnB', courses: widget.courses, selected: _selectedCourse,
